...
<template>
 <div style="width: 50%;">
	 <el-form :model="Customer" :rules="rules" ref="Customer" label-width="100px" class="demo-ruleForm">
	   <el-row>
		   <el-form-item label="操作网点:" prop="outletsId">
		     <el-input v-model="Customer.outletsId"></el-input>
		   </el-form-item>
		   <el-form-item label="操作人:" prop="addname">
		     <el-input v-model="Customer.addname"></el-input>
		   </el-form-item>
	   </el-row>
	   <el-row>
		   <el-form-item label="所属网点:" prop="reNetwork">
		     <el-select v-model="Customer.reNetwork" placeholder="请选择活动区域">
		       <el-option label="湖南网点" value="1"></el-option>
		       <el-option label="长沙网点" value="2"></el-option>
		     </el-select>
		   </el-form-item>
