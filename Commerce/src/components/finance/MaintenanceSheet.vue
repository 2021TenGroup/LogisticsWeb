			...
			<div class="grid-content2 bg-purple-dark1">
				<div>
					<el-table :data="CustomerData" @selection-change="handleSelectionChange" stripe
						...
						<el-table-column prop="outletsName" min-width="50" label="网点名称" align="center">
						</el-table-column>
						<el-table-column prop="userName" min-width="50" label="操作人" align="center">
						</el-table-column>
						<el-table-column prop="mdCollectMoney" min-width="50" label="收取金额" align="center">
						</el-table-column>
						<el-table-column prop="mdBalance" min-width="50" label="网店余额" align="center">
						</el-table-column>
						<el-table-column prop="mdType" min-width="50" label="类型" align="center" :formatter="mdTypeFormat">
						</el-table-column>
					</el-table>
...
<script>
	...
	export default {
		...
		created() {
			var _this = this
			this.axios.get("http://localhost:8089/Logistics/fiMoneyDetailed/selectAll", {
				params: this.pageInfo
			})
			.then(function(response) {
				console.log(response)
